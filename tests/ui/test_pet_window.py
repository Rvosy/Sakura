...
def test_tauri_settings_tts_test_builds_character_settings() -> None:
    from app.ui.tauri_settings import TauriTtsResult, _tts_settings_for_profile

    root = _ui_runtime_root("tauri_tts_test_settings")
    ...
    assert settings.character_name == "Sakura"
    assert settings.ref_audio_path.is_absolute()
