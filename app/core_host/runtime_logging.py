...
_FIXED_MESSAGES = {
    ...
    "plugin.migration.candidate_rejected": "插件迁移候选不可用",
    "plugin.migration.source_selected": "插件迁移来源已就绪",
    "plugin.migration.rollback_completed": "插件迁移已恢复原文件",
    "plugin.migration.failed": "插件迁移未完成",
    "plugin.migration.completed": "插件迁移检查结束",
    "assistant.initialization.failed": "Assistant 初始化失败",
