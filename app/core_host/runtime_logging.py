...
_FIXED_MESSAGES = {
    ...
    "tts.startup.started": "TTS startup started",
    "tts.startup.ready": "TTS startup ready",
    "tts.startup.failed": "TTS startup failed",
    "tts.startup.cancelled": "TTS startup cancelled",
    ...
    "tts.bundle.started": "TTS bundle installation started",
    "tts.bundle.progress": "TTS bundle installation progressed",
    "tts.bundle.completed": "TTS bundle installation completed",
    "tts.bundle.cancelled": "TTS bundle installation cancelled",
    "tts.bundle.failed": "TTS bundle installation failed",
    "tts.test.started": "TTS test started",
    "tts.test.ready": "TTS test ready",
    "tts.test.failed": "TTS test failed",
