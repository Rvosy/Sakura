...
from app.config.defaults import (
    BUBBLE_HEIGHT_MAX,
    BUBBLE_HEIGHT_MIN,
    CONTROL_PANEL_VERTICAL_OFFSET_MAX,
    CONTROL_PANEL_VERTICAL_OFFSET_MIN,
...
# 向后兼容别名
MIN_CONTROL_PANEL_WIDTH = CONTROL_PANEL_WIDTH_MIN
MAX_CONTROL_PANEL_WIDTH = CONTROL_PANEL_WIDTH_MAX
MIN_BUBBLE_HEIGHT = BUBBLE_HEIGHT_MIN
MAX_BUBBLE_HEIGHT = BUBBLE_HEIGHT_MAX
MIN_CONTROL_PANEL_VERTICAL_OFFSET = CONTROL_PANEL_VERTICAL_OFFSET_MIN
MAX_CONTROL_PANEL_VERTICAL_OFFSET = CONTROL_PANEL_VERTICAL_OFFSET_MAX
MIN_INPUT_BAR_OFFSET = INPUT_BAR_OFFSET_MIN
MAX_INPUT_BAR_OFFSET = INPUT_BAR_OFFSET_MAX
