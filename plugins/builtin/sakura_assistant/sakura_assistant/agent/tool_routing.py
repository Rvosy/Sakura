...
from sakura_assistant.agent.screen_policy import ScreenPolicy
from sakura_assistant.agent.tool_policy import BROWSER_SNAPSHOT_TOOL_NAME, ToolPolicy
from sakura_tools import ToolExecutionResult, ToolRegistry
from sakura_assistant.diagnostics import log_event
from sakura_assistant.llm.api_client import ChatMessage, NativeToolCall
...
def _execute_auto_browser_snapshot(tools: ToolRegistry, step_index: int) -> ToolExecutionResult:
    ...
    from sakura_assistant.agent.runtime import _redact_tool_result_for_model
...
def _messages_text_for_tool_routing(messages: list[ChatMessage]) -> str:
    ...
    from sakura_assistant.agent.runtime import _compact_continuation_context_content
