...
# ADR-0057：Release Action 导入草稿，维护者确认国内发布

## 决策

本决策 supersedes [ADR-0056](0056-private-console-and-service-domains.md) 与
[ADR-0055](0055-domestic-updater-manifest.md) 中 CI 直接发布国内公开清单的部分。
