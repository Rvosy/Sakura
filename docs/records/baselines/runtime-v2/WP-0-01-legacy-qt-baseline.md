...
- `docs/records/baselines/runtime-v2/run_wp_0_01_baseline.ps1`
- `docs/records/baselines/runtime-v2/wp_0_01_qt_smoke.py`
- `docs/plans/runtime-v2/work-packages.md` 中 WP-0-01 的状态和验收记录
...
脚本路径为 `docs/records/baselines/runtime-v2/run_wp_0_01_baseline.ps1`；GUI 子进程驱动位于 `docs/records/baselines/runtime-v2/wp_0_01_qt_smoke.py`。最终 accepted 批次的真实 `data/` 前后清单相同。
