...
`2a1bf3925d9688d1da1f7cb302fd9045adab2ea2`。固定 base 为
`80764fa55d9dbb69e44f4bd5f634093f44d79010`；当前 Work Package 状态只以
...
- 提交后 `runtime/bin/python3.12 -m harness check WP-4-04`：当前 WP、WP-4-03 accepted 依赖、固定 base、
