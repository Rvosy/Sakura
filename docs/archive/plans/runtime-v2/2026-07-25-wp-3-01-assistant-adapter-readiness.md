...
- Allowed production candidates are limited to the paths frozen in `docs/specs/runtime-v2/WP-3-01-qt-free-assistant-adapter-readiness.md`; all forbidden paths in that specification remain forbidden.
