...
实现 [`normative Spec`](../../../specs/runtime-v2/pre-simplification-2026-08-23/WP-4-04-python-plugin-capability-parity.md) 与
[`ADR-0016`](../../../../adr/0016-runtime-v2-generation-private-plugin-worker.md)；路线图状态只读
[`work-packages.md`](work-packages-history.md)。
